        ...
        <tr>
          ...
          ?>            
            ...
            <td><a href="javascript:;"
                  ...
                  <button data-toggle="modal" data-target="#ubah-data" class="btn btn-info"><i class="fa fa-pencil"></i></button></a></td>
        </tr>
          <?php }}?>
      </table>
    </div>
          ...
          <div class="modal-body">
            <div class="box-body">
              ...
              <div class="form-group">
                <label for="nama_bidang" class="col-sm-4 control-label">Nama Bidang</label>
                  <div class="col-sm-8">
                    <input type="text" name="nama_bidang" value="<?php echo $bid->nama_bidang;?>" class="form-control" placeholder="">
                  </div>
              </div>
              <div class="form-group">
                <label for="deskripsi" class="col-sm-4 control-label">Deskripsi</label>
                  <div class="col-sm-8">
                    <textarea name="deskripsi" class="form-control" rows="3" placeholder=""></textarea>
                  </div>
              </div>
            </div>
          </div>
